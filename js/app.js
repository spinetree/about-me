...
var guess = function() {
  ...
  function guessTheAge() {
    var guesses = 4;
    while (guesses > 0) {
      var answer = parseInt(window.prompt('Can you guess how freaking ancient I am? You have ' + guesses +' guesses left'));
      if (answer === 37) {
  ...
  function guessCountries() {
    var guesses = 6;
    while (guesses > 0) {
      var answer = window.prompt('Can you guess a country I\'ve visited? (Don\'t say the US that\'s dumb.) ' + guesses + ' guesses remaining.');
